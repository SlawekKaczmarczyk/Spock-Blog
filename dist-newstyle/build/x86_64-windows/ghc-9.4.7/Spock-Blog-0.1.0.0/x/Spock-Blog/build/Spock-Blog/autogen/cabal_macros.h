...
/* package Spock-Blog-0.1.0.0 */
#ifndef VERSION_Spock_Blog
#define VERSION_Spock_Blog "0.1.0.0"
#endif /* VERSION_Spock_Blog */
#ifndef MIN_VERSION_Spock_Blog
#define MIN_VERSION_Spock_Blog(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Spock_Blog */
...
#define CURRENT_COMPONENT_ID "Spock-Blog-0.1.0.0-inplace-Spock-Blog"
